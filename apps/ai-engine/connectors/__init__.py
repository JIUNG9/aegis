...
fetcher modules for logs, metrics (PromQL), traces, and alerts. Also
exposes the pattern_analyzer subpackage for time-based analysis on
the output of those fetchers.
